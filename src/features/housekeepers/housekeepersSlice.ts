...
const initialState: HousekeepersState = {
  housekeepers: [
    { id: 'h1', name: 'Анна', workloadCapacity: 50, assignedRooms: [], color: '#FFC107' },
    { id: 'h2', name: 'Иван', workloadCapacity: 50, assignedRooms: [], color: '#2196F3' },
    { id: 'h3', name: 'Мария', workloadCapacity: 50, assignedRooms: [], color: '#4CAF50' },
    { id: 'h4', name: 'Петр', workloadCapacity: 50, assignedRooms: [], color: '#E91E63' },
    { id: 'h5', name: 'Елена', workloadCapacity: 50, assignedRooms: [], color: '#9C27B0' },
  ],
};
